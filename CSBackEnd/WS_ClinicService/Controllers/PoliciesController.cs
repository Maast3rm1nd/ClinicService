...
namespace WS_ClinicService.Controllers
{
    ...
    public class PoliciesController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(PolicySnapshotDto), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<PolicySnapshotDto>> RestorePolicy(Guid entityId, CancellationToken cancellationToken)
            => Ok(await _mediator.Send(new RestorePolicyCommand(entityId), cancellationToken));
    }
}